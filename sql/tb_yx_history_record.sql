...
-- ----------------------------
-- Table structure for tb_yx_history_record
-- ----------------------------
DROP TABLE IF EXISTS `tb_yx_history_record`;
CREATE TABLE `tb_yx_history_record`  (
  `id` bigint(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `yxUserId` bigint(0) NOT NULL DEFAULT 0 COMMENT '用户userId',
  ...
  INDEX `idx_user_userId`(`yxUserId`) USING BTREE
